# Experience & Work Timeline — Ganesh Pawar
...
- **Responsibilities & Contributions:**
  ...
  - Reduced manual data analysis efforts by **40%** by implementing cross-validation and hyperparameter search pipelines.
...
- **Responsibilities & Contributions:**
  - Automated custom **ETL data pipelines** in Python & SQL, connecting external REST APIs to a PostgreSQL warehouse.
  - Designed responsive executive dashboards in **Power BI** using complex **DAX measures** to track KPIs.
...
- **Duration:** 2022 – 2026
- **Coursework & Focus:**
  - Specialization in Neural Networks, Deep Learning, Natural Language Processing, and Advanced DB.
  - Researcher in Multi-agent systems (LangGraph) and RAG optimizations.
